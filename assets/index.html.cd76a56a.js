import{_ as l,r as e,o as p,c as r,b as s,d as o,e as n,a as i}from"./app.a9cca246.js";const c={},t=s("h1",{id:"\u6392\u5E8F",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#\u6392\u5E8F","aria-hidden":"true"},"#"),n(" \u6392\u5E8F")],-1),D={href:"https://www.runoob.com/w3cnote/ten-sorting-algorithm.html",target:"_blank",rel:"noopener noreferrer"},d=n("1.0 \u5341\u5927\u7ECF\u5178\u6392\u5E8F\u7B97\u6CD5"),y=i(`<h2 id="\u5192\u6CE1" tabindex="-1"><a class="header-anchor" href="#\u5192\u6CE1" aria-hidden="true">#</a> \u5192\u6CE1</h2><div class="language-text ext-text line-numbers-mode"><pre class="shiki" style="background-color:#1E1E1E;"><code><span class="line"><span style="color:#D4D4D4;">func bubbleSort(arr []int) []int {
        length := len(arr)
        for i := 0; i &lt; length; i++ {
